...
namespace Twitter.Consumer.Api.Features.Tweets.Context
{
    public class BatchTweetContext : DataContext
    {
        ...
        protected BatchTweetContext(ScenarioContext context, ApiServer server) : base(context, server)
        {
